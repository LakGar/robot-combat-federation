    ...
    <footer className="bg-black border-t border-gray-800 py-12 md:py-16">
      <div className="container mx-auto px-4 md:px-6 lg:px-12">
        <div className="grid md:grid-cols-4 gap-8 md:gap-12 mb-8 md:mb-12">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-wider mb-4 text-gray-400">
              QUICK LINKS
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-500 text-sm tracking-wider">
              <li>INFO@RCF.COM</li>
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-gray-500 uppercase tracking-wider">
            © 2024 ROBOT COMBAT FEDERATION. ALL RIGHTS RESERVED.
          </p>
